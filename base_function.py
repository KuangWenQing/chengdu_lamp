...
def find_abnormal_data(arr: list):
    """
    :param arr: 一组数
    :return: 按最像异常排列的索引
    """
...
def sort_and_print_50_95_99(aim_list, keyword=' ', fd_st=None):
    ...
    print(keyword + " cep 50% = {:.3f}, 95% = {:.3f}, 99% = {:.3f}, std = {:.3f}"
...
alt_ = 100     # 模拟器
lat_ = convert_ll_to_float("40000.00001")
lon_ = convert_ll_to_float("11600.00001")

Tlla = (lat_, lon_, alt_)              # 度 （纬经高）
Txyz = lla_to_xyz(lat_, lon_, alt_)    # 米 （X Y Z）
